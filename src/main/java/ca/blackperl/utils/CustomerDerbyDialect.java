...
public class CustomerDerbyDialect extends org.hibernate.dialect.DerbyDialect {

	private static final Logger log = LogManager.getLogger(CustomerDerbyDialect.class);
